export const settingsZhCN = {
  settings: {
    ...
    webSearchClaudeApiKey: 'Claude API 密钥',
    webSearchApiKeyPlaceholder: '输入 API Key',
    webSearchApiKeyPlaceholderServer: '已配置服务端密钥，可选填覆盖',
    webSearchApiKeyHint: '请输入相应服务商提供的 API Key，用于网络搜索',
    webSearchBaseUrl: 'Base URL',
    webSearchServerConfigured: '服务端已配置 API 密钥',
    webSearchModelId: '模型 ID',
    webSearchApiVersion: 'API 版本',
    webSearchToolsConfiguration: '工具',
    webSearchNewTool: '新建工具',
    webSearchNoTools: '暂无已配置的工具',
    webSearchAddToolTitle: '添加工具',
    webSearchEditToolTitle: '编辑工具',
    webSearchToolDialogDesc: '配置 Claude 搜索工具的类型和名称',
    webSearchToolType: '类型',
    webSearchToolName: '名称',
    webSearchModelsConfiguration: '模型',
    webSearchNewModel: '新建模型',
    webSearchNoModels: '暂无已配置的模型。',
    webSearchNoModelsHint: '请添加至少一个模型才能使用 Claude 搜索。',
    webSearchAddModelTitle: '添加模型',
    webSearchEditModelTitle: '编辑模型',
    webSearchModelDialogDesc: '配置 Claude 搜索模型的 ID 和名称',
    webSearchModelIdField: '模型 ID',
    webSearchModelNameField: '模型名称',
    optional: '可选',
  },
  profile: {
    title: '个人资料',
...
export const settingsEnUS = {
  settings: {
    ...
    webSearchClaudeApiKey: 'Claude API Key',
    webSearchApiKeyPlaceholder: 'Enter API Key',
    webSearchApiKeyPlaceholderServer: 'Server key configured, optionally override',
    webSearchApiKeyHint: 'Enter the API key provided by the search service',
    webSearchBaseUrl: 'Base URL',
    webSearchServerConfigured: 'Server-side API key is configured',
    webSearchModelId: 'Model ID',
    webSearchApiVersion: 'API Version',
    webSearchToolsConfiguration: 'Tools',
    webSearchNewTool: 'New Tool',
    webSearchNoTools: 'No tools configured.',
    webSearchAddToolTitle: 'Add Tool',
    webSearchEditToolTitle: 'Edit Tool',
    webSearchToolDialogDesc: "Configure the tool's type and name for Claude search.",
    webSearchToolType: 'Type',
    webSearchToolName: 'Name',
    webSearchModelsConfiguration: 'Models',
    webSearchNewModel: 'New Model',
    webSearchNoModels: 'No models configured.',
    webSearchNoModelsHint: 'Add at least one model to use Claude search.',
    webSearchAddModelTitle: 'Add Model',
    webSearchEditModelTitle: 'Edit Model',
    webSearchModelDialogDesc: "Configure the model's ID and name for Claude search.",
    webSearchModelIdField: 'Model ID',
    webSearchModelNameField: 'Model Name',
    optional: 'Optional',
  },
  profile: {
    title: 'Profile',
